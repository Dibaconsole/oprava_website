...
"[project]/src/components/layout/ChatProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ChatProvider({ children }) {
    ...
    const msgsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const addMsg = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatProvider.useCallback[addMsg]": (role, text, opts)=>{
            setMessages({
                "ChatProvider.useCallback[addMsg]": (prev)=>[
                        ...prev,
                        {
                            id: nextId(),
                            role,
            ...
            }["ChatProvider.useCallback[addMsg]"]);
        }
    }["ChatProvider.useCallback[addMsg]"], []);
    const showWelcome = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatProvider.useCallback[showWelcome]": ()=>{
            setMessages([
                {
                    id: nextId(),
                    role: 'guide',
    ...
    const openGuide = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatProvider.useCallback[openGuide]": ()=>{
            setOpen(true);
            setMinimized(false);
            if (!initialized) {
                setInitialized(true);
    ...
    const closeGuide = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatProvider.useCallback[closeGuide]": ()=>{
            setOpen(false);
            setMinimized(false);
        }
    }["ChatProvider.useCallback[closeGuide]"], []);
    const scrollToSection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatProvider.useCallback[scrollToSection]": (sectionId)=>{
            closeGuide();
            setTimeout({
                "ChatProvider.useCallback[scrollToSection]": ()=>{
                    document.getElementById(sectionId)?.scrollIntoView({
                        behavior: 'smooth',
                        block: 'start'
                    });
                }
            }["ChatProvider.useCallback[scrollToSection]"], 350);
        }
    }["ChatProvider.useCallback[scrollToSection]"], [
        closeGuide
    ]);
    const handleTour = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatProvider.useCallback[handleTour]": ()=>{
            closeGuide();
    ...
    const handleChip = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatProvider.useCallback[handleChip]": (key, label)=>{
            addMsg('user', label);
            const answer = GUIDE_ANSWERS[key];
            setTimeout({
                "ChatProvider.useCallback[handleChip]": ()=>{
            ...
            }["ChatProvider.useCallback[handleChip]"], 300);
        }
    }["ChatProvider.useCallback[handleChip]"], [
        addMsg
    ]);
    const sendMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatProvider.useCallback[sendMessage]": ()=>{
            ...
            }["ChatProvider.useCallback[sendMessage]"], 300);
        }
    }["ChatProvider.useCallback[sendMessage]"], [
        inputVal,
        addMsg
    ]);
    const clearConversation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatProvider.useCallback[clearConversation]": ()=>{
            showWelcome();
        }
    }["ChatProvider.useCallback[clearConversation]"], [
        showWelcome
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatProvider.useEffect": ()=>{
            if (!open) return;
            const onKey = {
                "ChatProvider.useEffect.onKey": (e)=>{
                    if (e.key === 'Escape') closeGuide();
                }
            }["ChatProvider.useEffect.onKey"];
            document.addEventListener('keydown', onKey);
            return ({
                "ChatProvider.useEffect": ()=>document.removeEventListener('keydown', onKey)
            })["ChatProvider.useEffect"];
        }
    }["ChatProvider.useEffect"], [
        open,
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: messages.map((msg)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    msg.actionLabel && !msg.isTour && msg.section && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        className: "gm-action",
                                        type: "button",
                                    ...
                                    msg.isTour && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        className: "gm-action",
                                        type: "button",
                                        onClick: handleTour,
                                        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "gp-chips",
                        children: GUIDE_CHIPS.map((chip)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                className: "gp-chip",
                                type: "button",
...
_s1(ChatProvider, "2ncROtRltbZkGluB+Warrkw96cU=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$GuideProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/layout/GuideProvider.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$ChatProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/layout/ChatProvider.tsx [app-client] (ecmascript)");
;
...
function Nav() {
    ...
    const { startTour } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$GuideProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGuide"])();
    const { openChat } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$ChatProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChat"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Nav.useEffect": ()=>{
            const onScroll = {
...
_s(Nav, "bwFiQtRiZLK5oXyKLAeqElf892I=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$GuideProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGuide"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$ChatProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChat"]
    ];
});
_c = Nav;
var _c;
...
//# sourceMappingURL=src_components_136qge_._.js.map